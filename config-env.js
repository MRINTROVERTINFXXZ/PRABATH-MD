...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRABATH-MD~pn1RWTIK#vq_-p76iLMnAHhomk3ydTFIJGBH6S3WvKb-CLYm_AG4",
BOT_NUMBER: process.env.BOT_NUMBER || "94705613713",
PASSWORD: process.env.PASSWORD || "BLACKDEVIL",
GITHUB_USERNAME: process.env.GITHUB_USERNAME || "MRINTROVERTINFXXZ",
